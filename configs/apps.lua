...
return {
    ...
    Apps = {
        ...
        { id = 'photogram', label = 'Kaleido', icon = 'photogram', route = '/photogram', accent = '#D62976', base = false, enabled = true },
        { id = 'garages', label = 'Garages', icon = 'garages', route = '/garages', accent = '#6E5CF2', base = false, enabled = false },
        { id = 'homes', label = 'Homes', icon = 'homes', route = '/homes', accent = '#12B866', base = false, enabled = false },
        { id = 'ryde', label = 'Ryde', icon = 'ryde', route = '/ryde', accent = '#1c1c1e', base = true, enabled = true },
        { id = 'radio', label = 'Radio', icon = 'radio', route = '/radio', accent = '#30B0C7', base = false, enabled = false },
