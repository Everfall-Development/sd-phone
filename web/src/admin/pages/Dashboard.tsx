...
import { MessageSquare, Search, Smartphone, Users, VolumeX } from 'lucide-react';
        ...
        <div className="space-y-5">
            <Card className="p-4">
                ...
                <Input
                    ...
                    placeholder="Name, citizen ID, phone number, Quip handle or account username…"
                />
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <StatTile icon={<QuipMark color="white" className="h-4 w-4" />} label="Quip posts" value={stats?.birdyPosts} />
            ...
            <Card className="p-4 text-[12.5px] leading-relaxed text-zinc-500">
                ...
                installed apps, app accounts (password resets, force logout), Quip activity, texts and calls. Use the Quip tab to trace
