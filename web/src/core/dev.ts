...
export function devInjectMockData(): () => void {
    ...
    const payload: OpenPayload = {
        ...
        apps: [
            ...
            { id: 'photogram',   label: 'Kaleido',     icon: 'photogram',   route: '/photogram',   accent: '#D62976' },
            { id: 'ryde',        label: 'Ryde',        icon: 'ryde',        route: '/ryde',        accent: '#1c1c1e', base: true },
            ...
            { id: 'weazelnews', label: 'Weazel News', icon: 'weazelnews', route: '/weazelnews', accent: '#C8102E', base: true },
